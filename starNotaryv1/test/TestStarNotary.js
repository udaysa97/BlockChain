...
it("has correct name", async () => {
  let instance = await StarNotary.deployed(); // Making sure the Smart Contract is deployed and getting the instance. Cannot create single global instance. Was possible in old versions
...
it("star name changed", async () => {
  let instance = await StarNotary.deployed();
  let newName = "This is new name";
